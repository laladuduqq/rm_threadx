 ...
 *
 * tx_byte_pool_create(&tx_app_byte_pool, "usb byte pool", memory_area, 65536);
 */
...
usb_osal_thread_t usb_osal_thread_create(const char *name, uint32_t stack_size, uint32_t prio, usb_thread_entry_t entry, void *args)
{
    ...
    tx_byte_allocate(&tx_app_byte_pool, (VOID **)&thread_ptr, sizeof(TX_THREAD), TX_NO_WAIT);
    ...
    tx_byte_allocate(&tx_app_byte_pool, (VOID **)&pointer, stack_size, TX_NO_WAIT);
    if (pointer == TX_NULL) {
        USB_LOG_ERR("Create thread %s failed\r\n", name);
        while (1) {
        }
...
usb_osal_sem_t usb_osal_sem_create(uint32_t initial_count)
{
    ...
    tx_byte_allocate(&tx_app_byte_pool, (VOID **)&sem_ptr, sizeof(TX_SEMAPHORE), TX_NO_WAIT);
...
usb_osal_mutex_t usb_osal_mutex_create(void)
{
    ...
    tx_byte_allocate(&tx_app_byte_pool, (VOID **)&mutex_ptr, sizeof(TX_MUTEX), TX_NO_WAIT);
...
usb_osal_mq_t usb_osal_mq_create(uint32_t max_msgs)
{
    ...
    tx_byte_allocate(&tx_app_byte_pool, (VOID **)&queue_ptr, sizeof(TX_QUEUE), TX_NO_WAIT);
    ...
    tx_byte_allocate(&tx_app_byte_pool, (VOID **)&pointer, sizeof(uintptr_t) * max_msgs, TX_NO_WAIT);
...
struct usb_osal_timer *usb_osal_timer_create(const char *name, uint32_t timeout_ms, usb_timer_handler_t handler, void *argument, bool is_period)
{
    ...
    tx_byte_allocate(&tx_app_byte_pool, (VOID **)&timer, sizeof(struct usb_osal_timer), TX_NO_WAIT);
    ...
    tx_byte_allocate(&tx_app_byte_pool, (VOID **)&timer_ptr, sizeof(TX_TIMER), TX_NO_WAIT);
...
void *usb_osal_malloc(size_t size)
{
    ...
    tx_byte_allocate(&tx_app_byte_pool, (VOID **)&pointer, size, TX_WAIT_FOREVER);
